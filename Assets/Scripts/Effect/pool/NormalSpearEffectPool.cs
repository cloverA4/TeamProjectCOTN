...
public class NormalSpearEffectPool : MonoBehaviour
{

    [SerializeField] private WeaponEffectObject _normalSpearEffectPrefab;
    ...
    {
        WeaponEffectObject weaponEffectObject = Instantiate(_normalSpearEffectPrefab).GetComponent<WeaponEffectObject>();
