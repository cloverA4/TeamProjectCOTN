...
public class NormalDaggerEffectPool : MonoBehaviour
{

    [SerializeField] private WeaponEffectObject _normalDaggerEffectPrefab;
    ...
    {
        WeaponEffectObject weaponEffectObject = Instantiate(_normalDaggerEffectPrefab).GetComponent<WeaponEffectObject>();
