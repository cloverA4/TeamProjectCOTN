...
public class TitaniumSpearEffectPool : MonoBehaviour
{

    [SerializeField] private WeaponEffectObject _titaniumSpearEffectPrefab;
    ...
    {
        WeaponEffectObject weaponEffectObject = Instantiate(_titaniumSpearEffectPrefab).GetComponent<WeaponEffectObject>();
