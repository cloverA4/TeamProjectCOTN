...
public class TitaniumDaggerEffectPool : MonoBehaviour
{

    [SerializeField] private WeaponEffectObject _titaniumDaggerEffectPrefab;
    ...
    {
        WeaponEffectObject weaponEffectObject = Instantiate(_titaniumDaggerEffectPrefab).GetComponent<WeaponEffectObject>();
